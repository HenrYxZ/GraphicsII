...
{
       0,     0,     3,     7,     9,    13,    17,    19,    24,    29,
      32,    35,    37,    42,    44,    47,    49,    51,    54,    56,
      58,    63,    65,    67,    71,    73,    75,    78,    80,    85,
      88,    93,    99,   101,   104,   107,   109,   112
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      23,     0,    -1,    24,    25,    43,    -1,     3,    -1,    32,
      27,    28,    -1,    33,    27,    28,    -1,    20,    -1,    35,
      29,    30,    36,    -1,    35,    29,    31,    36,    -1,    37,
      39,    -1,    39,    37,    -1,    37,    -1,    34,    35,    37,
      36,    -1,    26,    -1,    31,    26,    -1,     4,    -1,     5,
      -1,    12,    13,    -1,    14,    -1,    15,    -1,     6,    38,
      38,    38,    -1,    19,    -1,    18,    -1,     7,    40,    41,
      -1,    18,    -1,    42,    -1,    41,    42,    -1,    21,    -1,
      44,    45,    46,    47,    -1,     8,    17,    -1,     9,    16,
      18,    17,    -1,    10,    11,    16,    38,    17,    -1,    48,
      -1,    47,    48,    -1,    49,    17,    -1,    50,    -1,    49,
      50,    -1,    38,    -1
};
...
{
       0,    40,    40,    42,    48,    50,    52,    57,    57,    59,
      59,    59,    61,    63,    63,    65,    67,    69,    72,    95,
     103,   111,   111,   114,   126,   137,   137,   139,   146,   150,
     152,   159,   165,   165,   167,   180,   180,   182
};
#endif
...
{
  "$end", "error", "$undefined", "HIERARCHY", "ROOT", "JOINT", "OFFSET",
  "CHANNELS", "MOTION", "FRAMES", "FRAME", "TIME", "END", "SITE", "LBRACK",
  "RBRACK", "COLON", "NEWLINE", "INT", "FLOAT", "ID", "PARAM", "$accept",
  "bvh", "header", "root", "joint", "id", "joint_post", "joint_info",
  "end_site", "joints", "root_tag", "joint_tag", "end_site_tag", "lbrack",
  "rbrack", "offset", "num", "channels", "numchans", "params", "param",
  "motion", "motion_header", "frames", "frame_time", "frame_info",
  "frame_line", "frame_body", "frame_float", YY_NULL
};
#endif
...
{
       0,     3,     0,     0,     1,    15,     0,     0,     0,     2,
       0,     6,     0,    29,     0,     0,    18,     4,     0,     0,
       0,     0,     0,     0,     0,    11,     0,     0,     0,    22,
      21,    37,    28,    32,     0,    35,     0,    24,     0,    16,
       0,    13,     0,     0,     0,     0,     9,    10,    30,     0,
      33,    34,    36,     0,    27,    23,    25,    17,    19,     7,
      14,     8,     0,     0,     0,    20,    26,     5,     0,    31,
      12
};
...
{
      -1,     2,     3,     6,    41,    12,    17,    24,    42,    43,
       7,    44,    45,    18,    59,    25,    31,    26,    38,    55,
      56,     9,    10,    15,    21,    32,    33,    34,    35
};
...
{
       7,   -42,    12,    10,   -42,   -42,     8,    -3,     3,   -42,
      13,   -42,     9,   -42,     5,    14,   -42,   -42,     2,    11,
      15,     0,     0,    16,    -1,    18,    24,    19,    17,   -42,
     -42,   -42,     0,   -42,   -12,   -42,     0,   -42,    20,   -42,
      22,   -42,    23,    -2,    -3,     9,   -42,   -42,   -42,     0,
     -42,   -42,   -42,     0,   -42,    20,   -42,   -42,   -42,   -42,
     -42,   -42,     9,    24,    25,   -42,   -42,   -42,    23,   -42,
     -42
};
...
{
     -42,   -42,   -42,   -42,    -4,   -13,   -22,   -42,   -42,   -42,
     -42,   -42,   -42,     1,   -41,   -26,   -21,    26,   -42,   -42,
     -11,   -42,   -42,   -42,   -42,   -42,    21,   -42,    27
};
...
{
      47,    36,    61,    39,    39,    51,    29,    30,    22,    23,
       1,    40,     4,    58,     5,    53,     8,    11,    29,    30,
      13,    19,    14,    16,    20,    23,    28,    70,    64,    27,
      22,    62,    65,    49,    37,    57,    48,    68,    58,    60,
      67,    54,    69,     0,    66,     0,    63,     0,     0,     0,
...
{
      26,    22,    43,     5,     5,    17,    18,    19,     6,     7,
       3,    12,     0,    15,     4,    36,     8,    20,    18,    19,
      17,    16,     9,    14,    10,     7,    11,    68,    49,    18,
       6,    44,    53,    16,    18,    13,    17,    63,    15,    43,
      62,    21,    17,    -1,    55,    -1,    45,    -1,    -1,    -1,
      -1,    25,    -1,    32,    -1,    -1,    -1,    -1,    -1,    -1,
      -1,    34
};
...
{
       0,     3,    23,    24,     0,     4,    25,    32,     8,    43,
      44,    20,    27,    17,     9,    45,    14,    28,    35,    16,
      10,    46,     6,     7,    29,    37,    39,    18,    11,    18,
      19,    38,    47,    48,    49,    50,    38,    18,    40,     5,
      12,    26,    30,    31,    33,    34,    39,    37,    17,    16,
      48,    17,    50,    38,    21,    41,    42,    13,    15,    36,
      26,    36,    27,    35,    38,    38,    42,    28,    37,    17,
      36
};
...
#line 103 "bvh.y"
    {
	curr.offset[0]=(yyvsp[(2) - (4)].fval);
	curr.offset[1]=(yyvsp[(3) - (4)].fval);
	curr.offset[2]=(yyvsp[(4) - (4)].fval);
...
#line 126 "bvh.y"
    {
	if((yyvsp[(1) - (1)].ival)<0) yyerror("Negative argument not allowed for numchans.");
	curr.numchans=(yyvsp[(1) - (1)].ival);
...
#line 159 "bvh.y"
	...
	if(bci && bci->set_frame_time)
		bci->set_frame_time((yyvsp[(4) - (5)].fval));
	BEGIN_FL();
}
    break;
...
#line 182 "bvh.y"
	...
	frameflt[frameidx++]=(yyvsp[(1) - (1)].fval);
}
    break;
